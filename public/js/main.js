document.addEventListener("DOMContentLoaded", () => {
  ...
  const logoSvgMarkup = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 64" role="img" aria-label="PBH — Photo Booth Hire Swansea" width="160" preserveAspectRatio="xMinYMid meet" style="display:block;width:160px;height:auto;min-width:140px">
