...
const events = [
  ...
  { icon: "🎉", eyebrow: "Birthday Parties",      title: "Private Parties & Birthdays",       desc: "Milestone birthdays, engagement parties, baby showers, and family celebrations all benefit from a booth that keeps guests entertained.", items: ["Flexible hire windows for daytime and evening parties","Props, themed strip layouts, and digital sharing","Suitable for homes, halls, hotels, and restaurants"] },
  { icon: "🎓", eyebrow: "Proms & Graduations",   title: "School & University Events",        desc: "We regularly work with Year 11, Sixth Form, and university celebrations where queues need to move quickly and the setup needs to feel safe.", items: ["DBS-checked attendants available for school and youth settings","Fast prints for friendship groups and family photos","Custom school or graduation branding on the strips"] },
  { icon: "🏢", eyebrow: "Corporate Events",      title: "Corporate & Brand Activations",     desc: "Launches, office parties, awards nights, and brand activations need something polished — a booth experience that stays on-brand.", items: ["Branded overlays and print templates","Professional hosting for client-facing events","Ideal for social sharing and internal events"] },
  { icon: "🎄", eyebrow: "Christmas Parties",     title: "Christmas & Seasonal Events",       desc: "Christmas parties, seasonal celebrations, and festive activations add a booth that keeps the room buzzing.", items: ["Festive backdrop and props options","Works for office, hotel, and venue hire nights","USB and online gallery included in all packages from 3 hours"] },
];
          ...
          {events.map(({ icon, eyebrow, title, desc, items }) => (
            <article key={title} className="reveal p-8 md:p-10 rounded-[var(--radius-xl)] flex flex-col md:flex-row gap-8 items-start" style={cardStyle}>
              ...
              <div className="flex-1">
                ...
                <Link href="/quickquote" className="btn btn-primary">Get a Quote</Link>
              </div>
            </article>
          ))}
        </div>
