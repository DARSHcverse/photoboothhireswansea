...
export const metadata: Metadata = {
  ...
  description:
    "Photo booth hire for brand activations, product launches and marketing events in Swansea and South Wales. Fully branded prints, custom overlays and a professional setup. From £220.",
