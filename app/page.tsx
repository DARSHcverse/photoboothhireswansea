            ...
            {[
              ...
              >
                ...
                <div className="p-5 flex flex-col gap-3 flex-1">
                  ...
                  <Link href="/services" className="btn btn-secondary mt-auto text-[0.82rem] min-h-[44px]">
                    Learn More
                  </Link>
                </div>
              </article>
      ...
      <section className="bg-sand" style={{ padding: "clamp(4.75rem,8vw,7.5rem) 0" }}>
        <div className="mx-auto px-4 md:px-3" style={{ maxWidth: "1240px" }}>
          ...
          <div className="grid gap-4" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(200px,1fr))" }}>
            {[
              { pill: "Weddings",   title: "Wedding Photo Booth Hire",       desc: "Soft glam lighting, premium strips, and a setup that stays full from first dance to final song.",       accent: "var(--color-rose)" },
              ...
              >
                ...
                <Link href="/services" className="btn btn-primary text-[0.82rem] min-h-[44px] mt-auto w-fit">
                  Explore
                </Link>
              </article>
            ))}
