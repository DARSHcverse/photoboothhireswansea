...
const PAGE_URL = "https://www.photoboothhireswansea.co.uk/photobooths";

export const metadata = {
  title: { absolute: "Photo Booths Swansea | Selfie Pod, Glam & Enclosed" },
  description:
    "Choose from our Selfie Pod, Glam Booth or Enclosed Booth for your Swansea event. All booths include unlimited prints and a professional attendant.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    type: "website",
    locale: "en_GB",
    siteName: "Photo Booth Hire Swansea",
    title: "Photo Booths Swansea | Selfie Pod, Glam & Enclosed",
    description:
      "Choose from our Selfie Pod, Glam Booth or Enclosed Booth for your Swansea event.",
    url: PAGE_URL,
  },
};

const booths = [
  { img: "/assets/boothimg6.webp", alt: "Selfie Pod photo booth hire Swansea",                                title: "Selfie Pod",       desc: "A sleek, modern open-air setup that fits any venue and encourages group shots and guest interaction. The most popular choice for weddings, corporate events, and birthday parties.", items: ["Sleek open-air design","Perfect for group shots and guest interaction","Most popular for weddings, brands, and birthdays"] },
  { img: "/assets/glam.png",       alt: "Glam Booth hire Swansea — Hollywood style black and white",         title: "Glam Booth",       desc: "The Glam Booth is our signature open air booth experience — designed for guests who want something a little more elevated. Using professional studio lighting and a carefully tuned black and white finish, every photo comes out with a cinematic, glamour feel. Think classic Hollywood portraits, not standard photo booth snaps. Perfect for weddings, milestone birthdays, and any event where the photos need to look as good as the night feels. Printed on the spot, sharp every time, and unlike anything else on the South Wales market.", items: ["Full-length portraits with glam styling","Black and white or colour finish","Ideal for weddings and premium events"] },
  { img: "/assets/enclosed.jpeg",  alt: "Enclosed photo booth hire Swansea",                                   title: "Enclosed Booth", desc: "A nostalgic, private photo booth experience. Perfect for school proms, weddings with a vintage theme, and guests who love the classic photo strip feel.", items: ["Classic enclosed booth feel","Great for proms and vintage-style weddings","Perfect for guests who love photo strips"] },
];
