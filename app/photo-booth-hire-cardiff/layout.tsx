...
export const metadata: Metadata = {
  ...
  description:
    "Professional photo booth hire in Cardiff and South Wales. Selfie Pods, Magic Mirrors and Enclosed Booths for weddings, parties, corporate events and school proms. From £220. Serving all Cardiff areas.",
  alternates: {
