...
const testimonials = [
  { stars: 5, text: "Shan was such a calming presence at our wedding and the booth looked incredible in the room.",                           name: "Aisha & Leon",     event: "Wedding · Swansea" },
  { stars: 5, text: "Every student wanted a print. The queue moved quickly and the quality was brilliant.",                                  name: "Mr. Fraser",       event: "Prom · North Swansea" },
  { stars: 5, text: "Professional from the first email and the branded strips were perfect for our launch.",                                  name: "Naomi K.",         event: "Corporate Event · Cardiff Bay" },
  { stars: 5, text: "The setup felt premium and every age group got involved. Exactly what we wanted.",                                       name: "Rachel T.",        event: "Birthday Party · Cardiff" },
  { stars: 5, text: "So easy to work with, lovely with the guests, and the guest book became one of our favourite keepsakes.",               name: "Hannah & James",   event: "Wedding · South Wales" },
  { stars: 5, text: "We booked for a Year 13 event and the energy was spot on. Fun, but really organised.",                                   name: "Mrs Ahmed",        event: "Sixth Form Prom · Cardiff" },
  { stars: 5, text: "The GIF booth was a huge hit with our team, and the social sharing station kept people coming back.",                   name: "Ben P.",           event: "Corporate Party · Swansea Bay" },
  { stars: 5, text: "Honestly one of the easiest suppliers we booked. Shan just got it and handled everything.",                             name: "Simran & Dev",     event: "Wedding · Swansea" },
  { stars: 5, text: "Our daughter loved every minute and the grandparents were back in the booth all evening too.",                          name: "Louise M.",        event: "Birthday Celebration · South Wales" },
];
...
export default function TestimonialsPage() {
  return (
    <main>
      <PageHero eyebrow="Client Love" title="Client Love" description="A few kind words from couples, schools, families, and brands who invited Photo Booth Hire Swansea to their events." heroBg="/assets/hero-banner-3.webp" />

      {/* Score summary */}
      <section style={{ padding: "clamp(3rem,5vw,5rem) 0" }}>
        <div className="mx-auto px-4 md:px-3" style={{ maxWidth: "1240px" }}>
          <div className="reveal p-5 md:p-8 rounded-[var(--radius-xl)] text-center flex flex-col gap-3 items-center" style={cardStyle}>
